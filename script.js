    ...
    <div class="product-card" style="animation-delay:${(i % 10) * 0.04}s">
      ...
      <div class="product-info">
        ...
        <div style="display:flex;gap:6px;margin-top:auto;">
          ...
          <button class="product-btn" style="flex:0 0 36px;padding:0;font-size:1.1rem;" onclick="event.stopPropagation();shareProduct('${p.title.replace(/'/g,"\\'")}','${p.affiliate_link}',event)" title="Compartilhar">➤</button>
        </div>
      </div>
    </div>
  `).join('');
